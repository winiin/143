...
function doRegister() {
  ...
  if(!validatePass(pass)){showErr('registerError',t('passWeak'));return;}
  const accs=getAccounts();
...
function showProfile() {
  ...
  m.innerHTML=`<div class="modal-box">
    ...
    ${!isPremium()?`<div style="margin-top:12px;padding:12px;background:linear-gradient(135deg,rgba(124,58,237,.15),rgba(6,182,212,.08));border:1px solid rgba(124,58,237,.3);border-radius:var(--r);text-align:center;">
